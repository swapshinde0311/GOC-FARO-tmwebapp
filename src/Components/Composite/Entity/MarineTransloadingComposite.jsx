...
import { MarineTransloadingSummaryPageComposite } from "../Summary/MarineTransloadingSummaryComposite";
...
import MarineTransloadingDetailsComposite from "../Details/MarineTransloadingDetailsComposite";
import Error from "../../Error";

class MarineTransloadingComposite extends Component {
  state = {
    isDetails: "false",
  ...
  componentName = "MarineTransloadingComponent";
  ...
  handleBack = () => {
    try {
      ...
      console.log(
        "MarineReceiptTransloadingComposite:Error occured on Back click",
        error
      );
    }
  };
  ...
  handleRowClick = (item) => {
    try {
      ...
      console.log(
        "MarineReceiptTransloadingComposite:Error occured on handleRowClick",
        error
      );
    }
  };
  ...
  handleSelection = (items) => {
    try {
      ...
      console.log(
        "MarineReceiptTransloadingComposite:Error occured on handleSelection",
        error
      );
    }
  };
  savedEvent = (data, saveType, notification) => {
    try {
      ...
      console.log(
        "MarineReceiptTransloadingComposite:Error occured on savedEvent",
        error
      );
    }
  };

  getMarineReceipTransloadingtList(shareholder) {
    ...
    axios(
      RestAPIs.GetMarineTransloadingForRole,
      ...
      .then((response) => {
        ...
        if (result.IsSuccess === true) {
          ...
          console.log(
            "Error in getMarineReceipTransloadingtListForRole:",
            result.ErrorList
          );
        }
      })
  ...
  componentDidMount() {
    try {
      ...
      console.log(
        "MarineReceiptTransloadingComposite:Error occured on componentDidMount",
        error
      );
    }
      ...
      .then((response) => {
        ...
        if (result.IsSuccess === true) {
          ...
          if (isEnable) {
            ...
            this.getMarineReceipTransloadingtList(
              this.props.userDetails.EntityResult.PrimaryShareholder
            );
          }
        } else {
  ...
  handleShareholderSelectionChange = (shareholder) => {
    try {
      ...
      this.getMarineReceipTransloadingtList(shareholder);
      this.getTerminalsList(shareholder);
    } catch (error) {
      console.log(
        "MarineReceiptTransloadingComposite:Error occured on handleShareholderSelectionChange",
        error
      );
    }
  };
      ...
      <div>
        ...
        {this.state.isDetails === "true" ? (
          ...
          <div>
            ...
            <ErrorBoundary>
              <MarineTransloadingSummaryPageComposite
                ...
                exportRequired={true}
                exportFileName="MarineTransloadingList"
          ...
          <>
            {this.state.isEnable ? (
              ...
              <Error errorMessage="MarineTransloadingDisabled"></Error>
            )}
          </>
        )}
...
export default connect(mapStateToProps)(MarineTransloadingComposite);

MarineTransloadingComposite.propTypes = {

...
class SAPlantsListASPXComposite extends Component {
  render() {
        ...
        <ErrorBoundary>
          <div className="detailsContainer">
            <object
              ...
              width="100%"
              height="880px"
              data={"/"+ tmuiInstallType +"/SAPlantsList.aspx"}
            ></object>
          </div>
        </ErrorBoundary>
      </div>
...
export default connect(mapStateToProps)(SAPlantsListASPXComposite);

SAPlantsListASPXComposite.propTypes = {

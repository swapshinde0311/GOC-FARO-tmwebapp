...
class SATemporaryOrderMappingInfoASPXComposite extends Component {
  render() {
        ...
        <ErrorBoundary>
          <div className="detailsContainer">
            <object
              ...
              width="100%"
              height="880px"
              data={"/" + tmuiInstallType + "/SATemporaryOrderMappingInfo.aspx"}
            ></object>
          </div>
        </ErrorBoundary>
      </div>
...
export default connect(mapStateToProps)(
  SATemporaryOrderMappingInfoASPXComposite
);

SATemporaryOrderMappingInfoASPXComposite.propTypes = {

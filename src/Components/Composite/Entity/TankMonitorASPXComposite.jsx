...
class TankMonitorASPXComposite extends Component {
  render() {
        ...
        <ErrorBoundary>
          <div className="detailsContainer">
            <object
              ...
              width="100%"
              height="880px"
              data={"/" + tmuiInstallType + "/TankMonitor.aspx"}
            ></object>
          </div>
        </ErrorBoundary>
      </div>
...
export default connect(mapStateToProps)(TankMonitorASPXComposite);

TankMonitorASPXComposite.propTypes = {

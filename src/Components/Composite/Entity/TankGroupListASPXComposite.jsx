...
class TankGroupListASPXComposite extends Component {
  render() {
        ...
        <ErrorBoundary>
          <div className="detailsContainer">
            <object
              ...
              width="100%"
              height="880px"
              data={"/" + tmuiInstallType + "/TankGroupList.aspx"}
            ></object>
          </div>
        </ErrorBoundary>
      </div>
...
export default connect(mapStateToProps)(TankGroupListASPXComposite);

TankGroupListASPXComposite.propTypes = {

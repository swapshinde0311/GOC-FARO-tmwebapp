...
class DeviceListASPXComposite extends Component {
  render() {
        ...
        <ErrorBoundary>
          <div className="detailsContainer">
            <object
              ...
              width="100%"
              height="880px"
              data={"/" + tmuiInstallType + "/DeviceList.aspx"}
            ></object>
          </div>
        </ErrorBoundary>
      </div>
...
export default connect(mapStateToProps)(DeviceListASPXComposite);

DeviceListASPXComposite.propTypes = {

...
class SAVehiclesInspectionStatusASPXComposite extends Component {
  render() {
        ...
        <ErrorBoundary>
          <div className="detailsContainer">
            <object
              ...
              width="100%"
              height="880px"
              data={"/" + tmuiInstallType + "/SAVehiclesInspectionStatus.aspx"}
            ></object>
          </div>
        </ErrorBoundary>
      </div>
...
export default connect(mapStateToProps)(
  SAVehiclesInspectionStatusASPXComposite
);

SAVehiclesInspectionStatusASPXComposite.propTypes = {

...
class SATruckRejectedOrderDetailsASPXComposite extends Component {
  render() {
        ...
        <ErrorBoundary>
          <div className="detailsContainer">
            <object
              ...
              data={"/" + tmuiInstallType + "/SATruckRejectedOrderDetails.aspx"}
            ></object>
          </div>
        </ErrorBoundary>
      </div>
...
export default connect(mapStateToProps)(
  SATruckRejectedOrderDetailsASPXComposite
);

SATruckRejectedOrderDetailsASPXComposite.propTypes = {
